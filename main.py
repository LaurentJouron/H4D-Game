...
class MainWidget(RelativeLayout):
    ...
    playlist = ['audio/Come_with_me.wav',
                'audio/Crash.wav',
                'audio/Fate-feat_Dan_Palmer(Zebrahead).wav',
                'audio/Highway.wav',
                'audio/Hooker.wav',
                'audio/My_best_friend.wav',
                'audio/My_way.wav',
                'audio/Shut_up.wav',
                'audio/Summer_day.wav',
                'audio/You.wav',
                'audio/You_re_gonna_loose_me.wav']

    state_game_over = False
    state_game_has_started = False

    menu_title = StringProperty("French Touch")
    ...
    def __init__(self, **kwargs):
        ...
        music1 = random.choice(playlist)
        self.init_audio(music1)
    ...
    def init_audio(self, music1):
        self.sound_begin = SoundLoader.load('audio/begin.wav')
        self.sound_galaxy = SoundLoader.load('audio/galaxy.wav')
        self.sound_gameover_impact = SoundLoader.load('audio/gameover_impact.wav')
        self.sound_gameover_voice = SoundLoader.load('audio/gameover_voice.wav')
        self.sound_music1 = SoundLoader.load(music1)
